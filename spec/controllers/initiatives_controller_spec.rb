...
RSpec.describe InitiativesController, :type => :controller do
  ...
  describe "GET index" do
    it "assigns all initiatives as @initiatives" do
      ...
      expect(assigns(:initiatives)).to eq([initiative])
    end
  end
  ...
  describe "POST create" do
    describe "with valid params" do
      ...
      it "assigns a newly created initiative as @initiative" do
        post :create, {:initiative => valid_attributes}, valid_session
        expect(assigns(:initiative)).to be_a(Initiative)
        expect(assigns(:initiative)).to be_persisted
      end

      it "redirects to the created initiative" do
        post :create, {:initiative => valid_attributes}, valid_session
        expect(response).to redirect_to(Initiative.last)
      end
    end

    describe "with invalid params" do
      it "assigns a newly created but unsaved initiative as @initiative" do
        post :create, {:initiative => invalid_attributes}, valid_session
        expect(assigns(:initiative)).to be_a_new(Initiative)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      ...
      it "updates the requested initiative" do
        initiative = Initiative.create! valid_attributes
        put :update, {:id => initiative.to_param, :initiative => new_attributes}, valid_session
        initiative.reload
        expect(initiative.name).to eq(new_attributes[:name])
      end
    ...
    describe "with invalid params" do
      it "assigns the initiative as @initiative" do
        initiative = Initiative.create! valid_attributes
        put :update, {:id => initiative.to_param, :initiative => invalid_attributes}, valid_session
        expect(assigns(:initiative)).to eq(initiative)
      end
  ...
  describe "DELETE destroy" do
    ...
    it "redirects to the initiatives list" do
      initiative = Initiative.create! valid_attributes
      delete :destroy, {:id => initiative.to_param}, valid_session
      expect(response).to redirect_to(initiatives_url)
    end
  end
